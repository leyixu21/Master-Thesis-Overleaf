...
To bridge this research gap, this study proposes to construct the semantic trajectories of locals and tourists in Greater London with Foursquare check-ins and Flickr tags. Greater London, an English-speaking city that attracts a significant number of tourists each year, provides an ideal setting for this study. Moreover, the abundance of Foursquare and Flickr users sharing check-ins and photos in Greater London lays a solid foundation for the construction of semantic trajectories. This study examines two research questions:
...
% ============================= || City Perception of Locals and Tourists || =============================
\subsection{City Perception of Locals and Tourists}

% ====================== | Visiting Behavior Investigation with UGC | ======================
...
% ====================== | City Perception Investigation with UGC | ======================
...
\underline{no evaluation of results}
